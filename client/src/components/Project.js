...
{ 
    return(
        ...
        <div className="button mt-2 d-flex flex-row align-items-center justify-content-center">  
        <button className="btn btn-sm btn-primary w-20 ml-2 " onClick={Apply}>Apply</button> </div>
        </div>
    )
}
else
...
const Project = ({LoggedIn,title, faculty, tags, status, description, require_of_student, criteria}) => {
    //console.log(tags);
    return (
