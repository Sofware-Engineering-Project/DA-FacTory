        ...
        <div className="d-flex align-items-center">
            ...
            <div className="ml-3 w-100">
                ...
                <div className="p-2 mt-2 bg-primary d-flex justify-content-between rounded text-white stats">
                    ...
                    <div className="d-flex flex-column"> <span className="followers">Area Of Interest</span> <span className="number2 d-flex justify-content-center">Cryptography</span> </div>
